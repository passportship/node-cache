...
class AsyncBaseCache {
    ...
    set(key, value, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.setValue(key, value, this.getDuration(duration));
        });
    }
    /**
    ...
    multiSet(items, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.setValues(data, this.getDuration(duration));
        });
    }
    /**
    ...
    add(key, value, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.addValue(key, value, this.getDuration(duration));
        });
    }
    /**
     * Stores multiple items in cache. Each item contains a value identified by a key.
    ...
    multiAdd(items, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.addValues(data, this.getDuration(duration));
        });
    }
    /**
