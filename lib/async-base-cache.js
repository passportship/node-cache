...
class AsyncBaseCache {
    ...
    multiGet(keys) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const values = yield this.getValues(_.values(keyMap));
            const results = {};
    ...
    set(key, value, duration = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.setValue(key, value, duration);
        });
    }
    /**
    ...
    multiSet(items, duration = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.setValues(data, duration);
        });
    }
    /**
    ...
    add(key, value, duration = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.addValue(key, value, duration);
        });
    }
    /**
     * Stores multiple items in cache. Each item contains a value identified by a key.
    ...
    multiAdd(items, duration = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.addValues(data, duration);
        });
    }
    /**
    ...
    getValues(keys) {
        return __awaiter(this, void 0, void 0, function* () {
            const results = {};
            for (const key of keys) {
                results[key] = yield this.getValue(key);
            }
            return results;
        });
    }
    ...
    setValues(data, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            const failedKeys = [];
            _.forEach(data, (value, key) => __awaiter(this, void 0, void 0, function* () {
                if ((yield this.setValue(key, value, duration)) === false) {
                    failedKeys.push(key);
                }
            }));
            return failedKeys;
    ...
    addValues(data, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            const failedKeys = [];
            _.forEach(data, (value, key) => __awaiter(this, void 0, void 0, function* () {
                if ((yield this.addValue(key, value, duration)) === false) {
                    failedKeys.push(key);
                }
            }));
            return failedKeys;
